...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Attach the filterPairs function to the keyup event listener of input fields
    document.getElementById('et1').addEventListener('keyup', handleEnterKey);
    document.getElementById('et2').addEventListener('keyup', handleEnterKey);
    document.getElementById('cn1').addEventListener('keyup', handleEnterKey);
    document.getElementById('cn2').addEventListener('keyup', handleEnterKey);
    document.getElementById('os1').addEventListener('keyup', handleEnterKey);
    document.getElementById('os2').addEventListener('keyup', handleEnterKey);
